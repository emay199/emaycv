...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'exp2-sub-label': '📁 Domains worked on',
    ...
    vn: {
      ...
      'hero-name': "Xin chào, mình là <em>Minh Anh</em>",
      ...
      'about-label': '01 — Giới thiệu', 'about-title': 'Đôi nét về mình',
      ...
      'about-avail': 'Sẵn sàng làm remote & toàn thời gian',
      ...
      'val-a-title': 'AI Agents cho Kiểm thử Phần mềm', 'val-a-desc': 'Ứng dụng các AI Agent để tạo test case, tự động hóa các tác vụ kiểm thử lặp đi lặp lại, phân tích lỗi và đẩy nhanh quá trình đảm bảo chất lượng (QA).',
      'val-c-title': 'QA cộng tác', 'val-c-desc': 'Kiểm thử là môn thể thao đồng đội. Mình là cầu nối giữa dev, sản phẩm và người dùng.',
      'skills-label': '02 — Kỹ năng', 'skills-title': 'Bộ công cụ kỹ thuật',
      'exp-label': '03 — Kinh nghiệm', 'exp-title': 'Nơi mình đã làm việc',
      'exp1-date': 'Tháng 10/2023 — Hiện tại', 'exp1-badge': 'Hiện tại',
      'exp1-role': 'Senior QA Engineer', 'exp1-company': 'Amnis Finance · Hà Nội, Việt Nam',
      'exp1-company-desc': 'Amnis Finance là giao thức tài chính phi tập trung (DeFi) được xây dựng trên blockchain Aptos, cung cấp các giải pháp liquid staking giúp người dùng stake tài sản kỹ thuật số, nhận thưởng và duy trì thanh khoản trong hệ sinh thái Web3.',
      ...
      'exp1-proj-label': '🚀 Dự án tiêu biểu',
      'exp2-sub-label': '📁 Lĩnh vực đã thực hiện',
      'exp1-p1-title': 'Amnis Finance – Staking Platform',
      'exp1-p1-b1': 'Thực hiện kiểm thử end-to-end trên Frontend, Backend và Smart Contract cho các tính năng staking, đảm bảo tính chính xác, bảo mật và trải nghiệm người dùng liền mạch.',
      'exp1-p1-b2': 'Xác nhận DAO governance, quản lý chiến lược và cải tiến UI/UX thông qua kiểm thử chức năng, API, database và on-chain.',
      'exp1-p1-b3': 'Kiểm thử chiến dịch incentive, retroactive rewards và phân phối airdrop bằng cách xác minh business logic, smart contract và giao dịch blockchain.',
      'exp1-p2-title': 'DEX Platform',
      'exp1-p2-b1': 'Thực hiện kiểm thử end-to-end trên Frontend, Backend và Smart Contract cho hoán đổi token, quản lý thanh khoản, cơ chế AMM và governance ve(3,3).',
      'exp1-p2-b2': 'Kiểm thử vote-escrow (veNFT), gauge voting, reward emissions, bribes và phân phối incentive qua kiểm thử chức năng, API, database và on-chain.',
      'exp1-p2-b3': 'Xác nhận tính năng thị trường thứ cấp, module launchpad, tương tác smart contract và luồng giao dịch để đảm bảo độ chính xác và ổn định.',
      'exp1-p3-title': 'Lending Protocol',
      'exp1-p3-b1': 'Thực hiện kiểm thử end-to-end trên Frontend, Backend và Smart Contract cho quy trình vay/cho vay, bao gồm cơ chế looping, quản lý tài sản thế chấp và tính toán lãi suất.',
      'exp1-p3-b2': 'Xác minh tích hợp API, tính nhất quán database, thực thi smart contract và giao dịch blockchain để đảm bảo tính toàn vẹn dữ liệu.',
      'exp1-p3-b3': 'Hỗ trợ chất lượng release thông qua regression testing, quản lý defect và cộng tác đa bộ phận.',
      'exp1-p4-title': 'Blockchain Super App',
      'exp1-p4-b1': 'Thực hiện kiểm thử end-to-end trên Frontend, Backend và Smart Contract cho quản lý ví, nạp tiền fiat, chuyển tiền on-chain, chuyển khoản nội bộ, sản phẩm yield, giao dịch P2P và thanh toán.',
      'exp1-p4-b2': 'Lập kế hoạch test, thực hiện kiểm thử chức năng, API, database, regression, UAT và on-chain để đảm bảo độ phủ tính năng đầy đủ.',
      'exp1-p4-b3': 'Xác nhận yêu cầu nghiệp vụ, tương tác smart contract, API và tính toàn vẹn dữ liệu bằng Postman, Swagger, MySQL, MongoDB, DBeaver và blockchain explorer trong môi trường Agile/Scrum.',
      'exp2-date': 'Tháng 7/2021 — Tháng 9/2023',
      'exp2-role': 'Junior Software QA', 'exp2-company': 'SYNERGIX TECHNOLOGIES PTE LTD',
      'exp2-company-desc': 'Synergix Technologies là đơn vị dẫn đầu Singapore về phần mềm ERP, giải pháp Cloud ERP và các dịch vụ liên quan. Là một trong những nhà phát triển hệ thống nội địa lớn nhất dành cho doanh nghiệp vừa và nhỏ, Synergix đã có hơn 15 năm hoạt động trong lĩnh vực ERP tại Singapore, Malaysia, Indonesia, Việt Nam và Myanmar.',
      ...
      'exp2-p1-customer': 'Doanh nghiệp Singapore',
      'exp2-p1-tech': 'Web Testing (Firefox / MS Edge / Chrome)',
      'exp2-p2-customer': 'Field Catering & Supplies Pte Ltd — Singapore',
      'exp2-p2-tech': 'Web Testing (Firefox / MS Edge / Chrome)',
      ...
      'edu1-degree': 'Cử nhân Tiếng Anh thương mại',
      'edu1-school': 'Đại học Kinh tế Quốc dân',
